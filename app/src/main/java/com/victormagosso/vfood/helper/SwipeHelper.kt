...
abstract class SwipeHelper(
    ...
    private var buttonList: MutableList<ButtonActions> = mutableListOf()
    lateinit var gestureDetector: GestureDetector
    var swipePosition = 1
    var swipeThreshold = 0.5f
    val buttonBuffer: MutableMap<Int, MutableList<ButtonActions>>
    ...
    override fun onChildDraw(
        ...
        if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
            if (dX < 0) {
                var buffer: MutableList<ButtonActions> = ArrayList()
